...
class Migration(migrations.Migration):
    dependencies = [("meupet", "0031_add_unique_constraint_for_name_and_owner_together")]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(name="petstatus", options={"ordering": ("description",)}),
