...
class SiteTestCases(StaticLiveServerTestCase):
    ...
    def create_pet():
        ...
        pet = mommy.make(
            Pet, owner=admin, name="Costela", description="Costelinha", profile_picture=get_test_image_file()
        )
        return pet
    ...
    def test_delete_pet(self):
        ...
        WebDriverWait(self.browser, 2).until(
            ec.visibility_of_element_located((By.CSS_SELECTOR, "input.btn-danger"))
        )
